...
class LX_Dich_Vu_V2_Widget extends \Elementor\Widget_Base
{

    public function get_name()
    {
        return 'lx_dich_vu_v2';
    }

    public function get_title()
    {
        return __('LX — Dịch vụ V2', 'lx-landing');
    }
        ...
        (function($) {
            ...
            $(window).on('elementor/frontend/init', function() {
                elementorFrontend.hooks.addAction(
                    'frontend/element_ready/lx_dich_vu_v2.default',
