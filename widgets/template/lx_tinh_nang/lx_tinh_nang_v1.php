...
class LX_Tinh_Nang_V1_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'lx_tinh_nang_v1';
    }

    public function get_title() {
        return __('LX — Tính năng V1', 'lx-landing');
    }
    ...
    protected function render() {
        ...
        <script>
            (function($) {
                ...
                var onInit = function() {
                    elementorFrontend.hooks.addAction('frontend/element_ready/lx_tinh_nang_v1.default', initGallery);
                };
