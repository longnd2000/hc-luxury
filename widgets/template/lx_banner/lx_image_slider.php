...
class LX_Image_Slider_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'lx_image_slider';
    }

    public function get_title() {
        return __('LX — Slider Hình ảnh', 'lx-landing');
    }
        ...
        (function($) {
            ...
            $(window).on('elementor/frontend/init', function() {
                elementorFrontend.hooks.addAction(
                    'frontend/element_ready/lx_image_slider.default',
