...
class LX_Hero_Slider_Widget extends \Elementor\Widget_Base
{
    public function get_name()
    {
        return 'lx_hero_slider';
    }

    public function get_title()
    {
        return __('LX — Hero Slider', 'lx-landing');
    }
        ...
        (function($) {
            ...
            $(window).on('elementor/frontend/init', function() {
                elementorFrontend.hooks.addAction(
                    'frontend/element_ready/lx_hero_slider.default',
