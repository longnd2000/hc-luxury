...
class LX_Danh_Gia_V1_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'lx_danh_gia_v1';
    }

    public function get_title() {
        return __('LX — Đánh giá V1', 'lx-landing');
    }
        ...
        (function($) {
            ...
            $(window).on('elementor/frontend/init', function() {
                elementorFrontend.hooks.addAction(
                    'frontend/element_ready/lx_danh_gia_v1.default',
